...
\begin{frame}{Objetivos generales}
	\vspace{-1.5cm}Desarrollar y validar un modelo probabilístico robusto, independiente de los GDD, que integre variables agroclimáticas significativas para estimar ventanas óptimas de fechas de siembra de maíz en Alemania.

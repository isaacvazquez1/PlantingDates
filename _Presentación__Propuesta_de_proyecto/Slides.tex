...
\begin{frame}{Modelo: Criterio de permanencia empírica}
	\vspace{-0.7cm}
	\begin{columns}
		\column{0.5\textwidth}
	\begin{figure}[ht]
	...
	\begin{columns}
		...
		$$P_i(\tau_F > n^*):=P(\tau_F > n^*\mid X_0=D_i),$$ con $\displaystyle\{\tau_F > n^*\}= \inf_{t\in \mathbb{N}} \{X_t= F\}.$\\
			\begin{block}{Suponiendo que $X$ es una cadena de Markov}
				$$P_i(\tau_F > n^*)=\prod_{t=0}^{n^*-1} \lambda_t \phantom{\geq \zeta^*.}$$
		\end{block}
		\column{0.5\textwidth}
		\begin{figure}[ht]
			\centering
...
\begin{frame}{Modelo: Criterio Markoviano de permanencia}
	...
	\begin{columns}
		...
		$$P_i(\tau_F > n^*):=P(\tau_F > n^*\mid X_0=D_i),$$ con $\displaystyle\{\tau_F > n^*\}= \inf_{t\in \mathbb{N}} \{X_t= F\}.$\\
		\begin{block}{Suponiendo que $X$ es una cadena de Markov}
			$$P_i(\tau_F > n^*)=\prod_{t=0}^{n^*-1} \lambda_t \geq \zeta^*.$$
		\end{block}
		\column{0.5\textwidth}
		\begin{figure}[ht]
			\centering

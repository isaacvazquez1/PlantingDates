...
La industria agrícola hace uso de grandes cantidades de agua para sostenerse y cubrir la demanda comercial \cite{Li_2022}. Así que la disponibilidad de agua tiene un rol crucial para los cultivos que acceden a ella directamente de la naturaleza exclusivamente o en conjunción con sistemas de riego \cite{Rockstrom_2010}.\\

De manera indistinta, tanto los cultivos de riego como los cultivos de temporal están expuestos al abastecimiento natural, como las lluvias y las reservas subterráneas \cite{Rockstrom_2010}. Por tanto, en caso de desabasto, los cultivos más afectados son aquellos de temporal \cite{Chen_2025}; mientras que en caso de sobresaturación de agua ambos tipos de cultivo resultan afectados \cite{VanderMolen_2007}.\\


Los desabastos de agua, o sequías, son situaciones en las que la cantidad de agua disponible resulta insuficiente para reponer la humedad que se pierde por la evapotranspiración \cite{Kumaraswamy_2016}. Es decir, tanto el ambiente como los cultivos pierden hidratación por la evaporación y por la transpiración vegetal, respectivamente \cite{Katul_2012}.\\


Con tal deficiencia de agua, el desarrollo, el crecimiento y la producción de las especies vegetales se ve mermado, llegando, potencialmente, a ocasionar la muerte de la planta entera \cite{Ngoune_2020}. Esto se ha atribuido a la producción y almacenamiento del ácido abscísico en las células de la planta, estimulando el cierre de sus estomas \cite{Li_2014}.\\

Lo anterior conlleva a la desnutrición de la planta dado que se impide la entrada de CO$_2$ y, por tanto, la fotosíntesis se ve reducida \cite{Gahir_2021}. De igual manera, al priorizar la búsqueda de agua a través de la expansión del sistema de raíces, la calidad de productos y semillas obtenidas se ve influenciada \cite{Comas_2013}.

...
Los GDD son unidades térmicas 
%%Growing degree days (GDD) from seeding were calculated using the equation first suggested by René-Antoine Ferchault de Réaumurin1730andagainpublishedbyMcMaster(1997)  and Moore and Remais (2014)

Y los resultados son buenos ya que 
%The problem with timing these activities is that shoot growth phenology, by  definition, depends not on the calendar but rather on climate, air temperature in  particular (Ashton 1975, Dahl and Mork 1959, Hari and Leikola 1974, Lanner  1964, Mitscherlich and others 1973, Sarvas 1972, Worrall 1973)

%\cite{Perala_1985}



%In open-field crop production, this concept is called “growing degree days” or “heat unit” and is widely applied in predicting the phenology in crop production. 

%2016, Plant Factory Chieri Kubota

%GDDs are frequently used in agriculture to estimate planting times and approximate dates of crop development stages.

%2013, Climate Vulnerability J.A. Winkler, ... C. Zavalloni

%https://www.sciencedirect.com/topics/agricultural-and-biological-sciences/growing-degree-day


 el contexto de crecimiento biológico

Similares a la metodología propuesta por Mitscherlich, E. (1909) \cite{Mitscherlich_1909}, se han propuesto más metodologías para comprender el desarrollo biológico; e.g., . No obstante, Koya \textit{et al.} (2013) \cite{Koya_2013} las generalizó    que tales metodologías  es un caso particular de 
...
No obstante, en trabajos previos como los de Elnesr \textit{et al.} \cite{Elnesr_2016, Elnesr_2013} se han desarrollado metodologías deterministas para pronosticar temporadas óptimas para la siembra de distintos tipos de cultivos, principalmente anuales. Lo anterior, basándose en el concepto de unidades de calor, donde el sistema de unidades de calor se basa en la acumulación promedio de las temperaturas diarias y los umbrales de temperatura respectivos al tipo de cultivo \cite{Chen_1973}.\\

...
\begin{frame}
	...
	\hfill \scriptsize Fuente: Chmielewski \textit{et al.} (2024); Sánchez \textit{et al.} (2014).
\end{frame}
...
\section{Ante las alteraciones en los procesos agrícolas derivadas del cambio climático, ¿cómo predecir ventanas de siembra de maíz en el sureste de Alemania mediante modelos probabilísticos empleando datos agroclimáticos más allá de los GDD?}
...
\begin{frame}{Datos agroclimáticos}
	...
	\begin{columns}
		...
		\begin{itemize}
			...
			\item Humedad del suelo disponible para el cultivo del maíz (0 -- 10 cm de profundidad).
		\end{itemize}
		{\tiny Fuente: Deutscher Wetterdienst (2025).}
		\column{0.60\textwidth}
		\begin{figure}[ht]
			\centering
			\includegraphics[height=0.8\textheight]{Mapa_final.png}
		\end{figure}
		\begin{center}
			\vspace{-0.5cm}
		\end{center}
...
\begin{frame}{Probabilidades de transición}
	...
	\begin{figure}[ht]
		...
		\begin{tikzpicture}[x=0.75pt,y=0.75pt,yscale=-1,xscale=1]
			...
			\draw  [fill={rgb, 255:red, 208; green, 2; blue, 27 }  ,fill opacity=1 ][line width=0.5]  (444,572.6) .. controls (444,570.06) and (446.24,568) .. (449,568) .. controls (451.76,568) and (454,570.06) .. (454,572.6) .. controls (454,575.14) and (451.76,577.2) .. (449,577.2) .. controls (446.24,577.2) and (444,575.14) .. (444,572.6) -- cycle ; %\draw  [line width=1.5]  (445.46,569.35) -- (452.54,575.85) ; \draw  [line width=1.5]  (452.54,569.35) -- (445.46,575.85) ;
			%Straight Lines [id:da05984024528227749] 
			\draw  [dash pattern={on 4.5pt off 4.5pt}]  (153,492.2) -- (153,572.7) ;
			\draw  [dash pattern={on 4.5pt off 4.5pt}]  (153,572.7) -- (444,572.7) ;
			%Shape: Circle [id:dp618933165821857] 
			\draw  [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ,fill opacity=1 ] (146.6,453.2) .. controls (146.6,450.88) and (148.48,449) .. (150.8,449) .. controls (153.12,449) and (155,450.88) .. (155,453.2) .. controls (155,455.52) and (153.12,457.4) .. (150.8,457.4) .. controls (148.48,457.4) and (146.6,455.52) .. (146.6,453.2) -- cycle ;
...
\begin{frame}{Probabilidades de transición}
	...
	\begin{figure}[ht]
		...
		\begin{tikzpicture}[x=0.75pt,y=0.75pt,yscale=-1,xscale=1]
			...
			% Text Node
			\draw (104,588.4) node [anchor=north west][inner sep=0.75pt]  [font=\small] [align=left] {\begin{minipage}[lt]{85.87pt}\setlength\topsep{0pt}
					\begin{center}
						Historical data\\from the $k$-th day\\ (1996--2025)
					\end{center}
			...
			\end{minipage}};
			% Text Node
			\draw (393,460.4) node [anchor=north west][inner sep=0.75pt]  [font=\small] [align=left] {\begin{minipage}[lt]{78.21pt}\setlength\topsep{0pt}
					\begin{center}
			...
			% Text Node
			\draw (436,544.4) node [anchor=north west][inner sep=0.75pt]    {$C^*$};
			\draw (227,540.8) node [anchor=north west][inner sep=0.75pt]    {$d_{p}( C_{H,k} \ \mathbf{,}\ C^*)$};
			% Text Node
			%\draw (110,600.4) node [anchor=north west, font=\Large][inner sep=0.75pt] {
			%	$\displaystyle 
			%	\lambda_k := 1 - \frac{d(C_{H,k}\,,\, C^*)}{\displaystyle\max_{l\in \{1,\dots,365\}} \{d(C_{H,l}\,,\, C^*)\}}.$
...
\begin{frame}{Resultados: Brandenmburgo}
	\vspace{-0.7cm}
	\begin{columns}[c]
		...
		\centering
		\hspace{-0.5cm}
		\includegraphics[height=0.65\textheight]{Suitability.png}
	\end{columns}
\end{frame}


\begin{frame}{Resultados: Sajonia}
	\vspace{-0.7cm}
	\begin{columns}[c]
		\column{0.48\textwidth}
		\centering
...
\begin{frame}{Resultados: Baviera}
	\vspace{-0.7cm}
	\begin{columns}[c]
		\column{0.48\textwidth}
		\centering
...
\begin{frame}{Revistas indexadas}
	\vspace{-0.7cm}
	\begin{table}[h]
		\centering
